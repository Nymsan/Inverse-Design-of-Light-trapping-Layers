...
CNN_CONV_CHANNELS="64 128 128 64"
CNN_KERNEL_SIZE="9"
CNN_FC_DIMS="448 128"
CNN_DROPOUT="0.05"

SKIPCNN_CONV_CHANNELS="48 96 128 64"
SKIPCNN_KERNEL_SIZE="9"
SKIPCNN_FC_DIMS="320 256"
SKIPCNN_DROPOUT="0.05"

SIREN_CONV_CHANNELS="48 96 96"
SIREN_KERNEL_SIZE="9"
SIREN_FC_DIMS="256 128"
SIREN_LATENT_DIM="64"
SIREN_OMEGA_0="30.0"
SIREN_DROPOUT="0.05"
...
# Inverse Models
INV_CONV_CHANNELS="48 96 128 64"
INV_KERNEL_SIZE="9"
INV_FC_DIMS="288 256"
INV_DROPOUT="0.05"

CVAE_GEO_ENC_CONV="32 64 64"
CVAE_GEO_ENC_KERNEL="9"
CVAE_GEO_ENC_FC="256 256"
CVAE_GEO_ENC_DROPOUT="0.05"

CVAE_GEO_DEC_FC="256 256"
CVAE_GEO_DEC_DROPOUT="0.05"

CVAE_SPEC_ENC_CONV="32 64 128 64"
CVAE_SPEC_ENC_KERNEL="9"
CVAE_SPEC_ENC_FC="256 256"
CVAE_SPEC_ENC_DROPOUT="0.05"
