...
There is the inherent issue of aliasing. The common way to optimize broadband applications is by solving the optical problems for each desired frequency in some resolution. This scales the complexity linearly with the frequency resolution.
