...
One of the upsides of RCWA is that its algorithmic time doesnt depend on the size of the optical system. The entire calculation takes place in fourier space.
This also leads to one of its largest downsides. Poorly truncated fourier series, that cant resolve the periodic structure leads to ill-conditioning of the problem. If structures have harsh, sharp edges, 
